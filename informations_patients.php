<?php
    ...
    $infos_clients = $bdd->query("SELECT * FROM informations_clients");
?>
<!DOCTYPE html>
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="row post-masonry post-columns" style="position: relative; height: 1464px;">
                      <div class="col-md-4 col-lg-4" style="position: absolute; left: 0px; top: 0px;">
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">Maladies chroniques&nbsp;&nbsp;<span class="fa fa-folder"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="infos.php?v=1" target="_blank">Plus informations</a></div>
                        </div>
                      </div>
                        ...
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">Gynécologie&nbsp;&nbsp;<span class="fa fa-folder"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="infos.php?v=2" target="_blank">Plus informations</a></div>
                        </div>
                      </div>
                        ...
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">Grossesse&nbsp;&nbsp;<span class="fa fa-folder"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="infos.php?v=3" target="_blank">Plus informations</a></div>
                        </div>
                      </div>
                        ...
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">Diététique et régime&nbsp;&nbsp;<span class="fa fa-folder"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="infos.php?v=4" target="_blank">Plus informations</a></div>
                        </div>
                      </div>
                        ...
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">Autres&nbsp;&nbsp;<span class="fa fa-folder"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="infos.php?v=5" target="_blank">Plus informations</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
