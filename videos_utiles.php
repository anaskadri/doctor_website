<?php
    ...
    $video= $bdd->query("SELECT * FROM videos_utiles");
?>
<!DOCTYPE html>
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top navbar-transparent" role="navigation">
        ...
        <div class="main">
            <section class="module" style="background-image: url(css/img/img9.jpeg);">
              <div class="container">
                  <h2 class="module-title font-alt">Videos utiles</h2>
                <div class="row">
                  <div class="col-sm-12">
                    <div class="row post-masonry post-columns" style="position: relative; height: 1464px;">
                      
                    <?php    
                        while ($infos=$video->fetch()) {
                            
                        echo '<div class="col-md-4 col-lg-4" style="position: absolute; left: 0px; top: 0px;">
                        <div class="post">
                          <div class="post-header font-alt">
                            <h2 class="post-title" style="font-size:14pt;color:#5b7b3c;">'.$infos['titre'].'&nbsp;&nbsp;&nbsp;<span class="fa fa-file-video-o"></span></h2>
                          </div>
                          <div class="post-more"><a class="more-link" href="'.$infos['lien'].'" target="_blank">Plus informations</a></div>
                        </div>
                      </div>'; }
                        ?>
                    </div>
